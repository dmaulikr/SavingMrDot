...
class RDRObstacle: SKSpriteNode {
    ...
    func startFire() {
        self.runAction(SKAction.sequence(
            [motions.playGifForOnce("FIRE_" + constants.gameDN.uppercaseString + "_BEGIN", frames: constants.motionMap["FIRE-BEGIN"]!),
             motions.playGifForOnce("FIRE_" + constants.gameDN.uppercaseString + "_DURING", frames: constants.motionMap["FIRE-DURING"]!),
             motions.playGifForOnce("FIRE_" + constants.gameDN.uppercaseString + "_END", frames: constants.motionMap["FIRE-END"]!) ]))
    }
